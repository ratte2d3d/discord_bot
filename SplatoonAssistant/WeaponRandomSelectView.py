...
class WeaponRandomSelectView(View):
    ...
    def random_selection(self):
        ...
        embed.add_field(name=f"選択された{self.name}", value=self.selected_value, inline=True)
    ...
    async def confirm_button(self, interaction: discord.Interaction, button: Button):
        ...
        self.current_embed.set_footer(text=f"選択が確定しました。確定者: {interaction.user.display_name}")

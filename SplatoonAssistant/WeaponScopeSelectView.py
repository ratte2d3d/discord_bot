...
class WeaponScopeSelectView(View):
    ...
    def type_select(self):
        ...
        embed.set_thumbnail(url="https://pbs.twimg.com/profile_images/938681212423454720/tgHfG8vm_400x400.jpg")
        # embedセット
    ...
    # 「スペシャル」ボタンの定義
    @discord.ui.button(label="スペシャル", style=discord.ButtonStyle.secondary, emoji="🚀")
